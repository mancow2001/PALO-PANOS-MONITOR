...
copy_application_files() {
    ...
    if [[ -d "templates" ]]; then
        ...
        print_success "Templates directory copied"
    else
        print_info "Templates directory not found - will be auto-generated by application"
    fi
...
test_installation() {
    ...
    if [[ -d "$INSTALL_DIR/templates" ]]; then
        print_info "Templates directory found: $INSTALL_DIR/templates"
    else
        print_info "Templates directory not found (will be auto-generated)"
    fi
